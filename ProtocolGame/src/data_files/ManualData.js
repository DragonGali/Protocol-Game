export const manualData = {
    Chapters: {
        "chapter_1": {
            ...
            pages: {
                "page_1": {
                    ...
                    "line_2": ' אפשר לחשוב על זה כמו שיחת טלפון:',
                    "line_3": '* מי שמתקשר אומר "הלו" </br>  * הצד השני עונה<br> * רק אז מדברים<br> * ובסוף? נפרדים עם "להתראות"'
                },
                "page_2": {
                    "line_1": "בלי הסדר הזה - אף אחד לא יבין מה קורה. גם בעולם הדיגיטלי, כל הודעה חייבת להישלח לפי פרוטוקול מסודר.",
                    "line_2": '<span style="font-size:var(--font-title-large); text-decoration: underline">איך נראית הודעה פרוטוקולית?</span>',
                    "line_3": 'כל הודעה מחולקת למספר חלקים, שכל אחד מהם אחראי על משהו שונה בהעברה.'
                },
                "page_3": {
                    "line_1": "* פתיחה <span style='color:var(--red)'> (header)</span> <br> מידע טכני: מי שלח, למי, באיזה פרוטוקול, ועוד.",
                    "line_2": "* מידע <span style='color:var(--red)'>(data)</span> <br> ההודעה עצמה - הקובץ, הטקסט או הנתונים.",
                    "line_3": "* סיומת <span style='color:var(--red)'>(Footer)</span> <br> סימן מוסכם לסיום. לפעמים כולל בדיקת תקינות <span style='color:var(--red)'>(Checksum)</span>.",
                },
                "page_4": {
                    "line_1": "אם חסר חלק? ההודעה לא תעבור כמו שצריך.",
                    "line_2": "<span style='font-size:var(--font-title-large); text-decoration: underline'>מה נלמד בהמשך?</span>",
                    "line_3": "בכל פרק תלמד על פרוטוקול אחר.לכל אחד יש חוקים משלו - מה מותר, מה חובה, ואיפה אסור לטעות."
                },
            }
        },
        "chapter_2": {
        ...
        "chapter_11" : {
            ...
            pages: {
                "page_1" : {
                    "line_1" : `DNS הוא פרוטוקול המאפשר למפות שמות תחום (Domain Names) לכתובות IP, ובכך שהוא בעל יכולת גישה לבסיס נתונים ועל פיו למפות לפי הדרישות.`,
